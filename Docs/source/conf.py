...
latex_documents = [
    (master_doc, 'Controls.tex', u'Controls Documentation',
     u'LHR Solar', 'manual'),
]
...
man_pages = [
    (master_doc, 'controls', u'Controls Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Controls', u'Controls Documentation',
     author, 'Controls', 'One line description of project.',
     'Miscellaneous'),
]
