...
``bool Contactors_Get(contactor_t contactor, bool blocking)`` — Gets the state of a given contactor. For the motor controller contactor, this operation simply queries the GPIO pin state in a critical section.
