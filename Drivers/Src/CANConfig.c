 ...
 *        Indexed by CANId_t values. Any changes or additions must be made in
...
const CANLUT_T CANLUT[NUM_CAN_IDS] = {
    [BPS_TRIP] =
        {NOIDX,
         DOUBLE}, /**	   BPS_TRIP **/
    [BPS_ALL_CLEAR] = {NOIDX,
                       DOUBLE}, /**     BPS_ALL_CLEAR **/
    [BPS_CONTACTOR_STATE] =
        {NOIDX, DOUBLE},                 /**	   BPS_CONTACTOR_STATE			   **/
    ...
    [ARRAY_CONTACTOR_STATE_CHANGE] =
        {NOIDX, BYTE},               /**     ARRAY_CONTACTOR_STATE_CHANGE    **/
...
CANId_t carCANFilterList[NUM_CARCAN_FILTERS] = {
    BPS_TRIP, STATE_OF_CHARGE, SUPPLEMENTAL_VOLTAGE, CHARGE_ENABLE};
