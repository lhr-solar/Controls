...
void  CPU_TS_TmrInit (void)
{
    ...
    Init_TIM1.TIM_Prescaler = 1;
    Init_TIM1.TIM_CounterMode = TIM_CounterMode_Up;
    Init_TIM1.TIM_Period = (uint32_t)0xFFFFFFFF;
    Init_TIM1.TIM_ClockDivision = TIM_CKD_DIV1;
    Init_TIM1.TIM_RepetitionCounter = 0;
