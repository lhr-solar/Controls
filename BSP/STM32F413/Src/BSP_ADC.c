...
static void ADC_InitDMA(void) {
	...
	DMA_InitStruct.DMA_BufferSize = NUMBER_OF_CHANNELS; // Changed this to fit the number of channels - more changes needed?
...
void BSP_ADC_Init(void) {
    ...
    ADC_RegularChannelConfig(ADC1, ExtraADC_1_CHANNEL, 3, ADC_SampleTime_480Cycles); // Extra 1
    ADC_RegularChannelConfig(ADC1, ExtraADC_2_CHANNEL, 4, ADC_SampleTime_480Cycles); // Extra 2
