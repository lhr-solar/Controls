...
void goToCoastingCruise(){
    ...
    set_cruiseEnable(true);
    set_cruiseSet(false);
    set_velocityObserved(40);
    set_cruiseVelSetpoint(30);
    stateBuffer();
}
...
void Task1(void *arg)
{
    ...
    */
    ...
    set_cruiseEnable(true);
    set_cruiseSet(true);
    set_velocityObserved(20.0);
    stateBuffer();
    set_velocityObserved(25.0);
    stateBuffer();
