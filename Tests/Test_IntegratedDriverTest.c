...
int main() {
    ...
    while (1){
        ...
        printf("||Display Test: Speed=%f, cruiseEnabled=%d, cruiseSet=%d, regenEnabled=%d, canError=%d,|| ",packet.speed,packet.cruiseEnabled,packet.regenEnabled,packet.canError);
    }
}
