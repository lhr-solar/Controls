...
int main(){
    ...
    car.MotorErrorCode = (motor_error_code_t) {false, false, false, false};
    ...
    //data[8] = {0x00, 0x00, 0x00, 0x00,      0x01, 0x08, 0x00, 0x44};
    check = MotorController_Read(&tester, &car);
    ...
    //data[8] = {0x00, 0x00, 0x00, 0x00,      0x00, 0x08, 0x00, 0x44};
    check = MotorController_Read(&tester, &car);
    ...
    //data[8] = {0x00, 0x00, 0x00, 0x00,      0x00, 0x08, 0x00, 0x40};
    check = MotorController_Read(&tester, &car);
    ...
    //data[8] = {0x00, 0x00, 0x00, 0x00,      0x00, 0x00, 0x00, 0x40};
    check = MotorController_Read(&tester, &car);
