...
DEFINE_FAKE_VALUE_FUNC(Gear_t, GetGear);
DEFINE_FAKE_VALUE_FUNC(TritiumState_t, GetState);
...
DEFINE_FAKE_VOID_FUNC(SetGear, Gear_t);
DEFINE_FAKE_VOID_FUNC(SetState, TritiumState_t);
