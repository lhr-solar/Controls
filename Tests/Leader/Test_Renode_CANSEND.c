 ...
 * It is designed to send messages on CAN1 (CARCAN) and go through all possible states of BPS sending us Charge messages.
 * This includes sending us the message on time, sending us the message late, sending us the message early, and sending us the DISABLE message.
 * It also tests a boundary condition case, where it alternates between DISABLE and ENABLE, testing that the main machine can handle this.
 * 
