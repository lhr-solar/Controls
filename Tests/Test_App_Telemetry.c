...
void Task1(void *arg) {
  ...
  OSTaskCreate(
      (OS_TCB *)&Telemetry_TCB, (CPU_CHAR *)"Telemetry",
      (OS_TASK_PTR)Task_Telemetry, (void *)NULL, (OS_PRIO)TASK_TELEMETRY_PRIO,
      (CPU_STK *)Telemetry_Stk, (CPU_STK_SIZE)WATERMARK_STACK_LIMIT,
      (CPU_STK_SIZE)TASK_TELEMETRY_STACK_SIZE, (OS_MSG_QTY)0, (OS_TICK)0,
  ...
  while (1) {
    ...
    // Use a logic analyzer to read the CAN line and see if the data shows up
    // correctly
  }
}
