...
int main(void) {
    ...
    // Initialize apps
    OSTaskCreate((OS_TCB *)&Init_TCB, (CPU_CHAR *)"Init",
                 (OS_TASK_PTR)Task_Init, (void *)NULL, (OS_PRIO)TASK_INIT_PRIO,
                 (CPU_STK *)Init_Stk, (CPU_STK_SIZE)WATERMARK_STACK_LIMIT / 10,
...
void Task_Init(void *p_arg) {
    ...
    OSTaskCreate((OS_TCB *)&FaultState_TCB, (CPU_CHAR *)"FaultState",
                 (OS_TASK_PTR)Task_FaultState, (void *)NULL,
                 (OS_PRIO)TASK_FAULT_STATE_PRIO, (CPU_STK *)FaultState_Stk,
                 (CPU_STK_SIZE)WATERMARK_STACK_LIMIT,
                 (CPU_STK_SIZE)TASK_FAULT_STATE_STACK_SIZE, (OS_MSG_QTY)0,
    ...
    OSTaskCreate(
        (OS_TCB *)&UpdateDisplay_TCB, (CPU_CHAR *)"UpdateDisplay",
    ...
    OSTaskCreate((OS_TCB *)&ReadTritium_TCB, (CPU_CHAR *)"ReadTritium",
    ...
    OSTaskCreate((OS_TCB *)&SendCarCAN_TCB, (CPU_CHAR *)"SendCarCAN",
                 (OS_TASK_PTR)Task_SendCarCAN, (void *)NULL,
                 (OS_PRIO)TASK_SEND_CAR_CAN_PRIO, (CPU_STK *)SendCarCAN_Stk,
                 (CPU_STK_SIZE)WATERMARK_STACK_LIMIT,
    ...
    OSTaskCreate((OS_TCB *)&DebugDump_TCB, (CPU_CHAR *)"DebugDump",
                 (OS_TASK_PTR)Task_DebugDump, (void *)NULL,
                 (OS_PRIO)TASK_DEBUG_DUMP_PRIO, (CPU_STK *)DebugDump_Stk,
                 (CPU_STK_SIZE)WATERMARK_STACK_LIMIT,
                 (CPU_STK_SIZE)TASK_DEBUG_DUMP_STACK_SIZE, (OS_MSG_QTY)0,
                 (OS_TICK)0, (void *)NULL, (OS_OPT)(OS_OPT_TASK_STK_CLR),
                 (OS_ERR *)&err);
    assertOSError(OS_MAIN_LOC, err);
    ...
    while (1) {
        Contactors_Set(
            MOTOR_CONTACTOR, Minions_Read(IGN_2),
            true);  // turn on the contactor if the ign switch lets us
        assertOSError(OS_MINIONS_LOC, err);
        OSTimeDlyHMSM(0, 0, 0, IGN_CONT_PERIOD, OS_OPT_TIME_HMSM_NON_STRICT,
                      &err);
    }
}
