 ...
 * calling the appropriate function. The command line interface is also
 * responsible for printing out the prompt and the results of commands.
 *
 ...
 * - Setting/Reading the state of the Contactors (see
 * [Contactors](../Drivers/Contactors.html))
 * - Setting/Reading the value of any GPIO inputs/outputs (see
 * [Minions](../Drivers/Minions.html))
