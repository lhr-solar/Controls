/**
 * @file CommandLine.c
 * @brief This file contains the command line interface, which is used to send commands to the car (and receive feedback) over UART. This is mainly useful for **debugging purposes only**, which is why it isn't enabled by default in [Init Task](./Main.html)
 * 
 ...
 * 
 * - Sending/Reading to the CANbus (see [CANBus](../Drivers/CANBus.html))
 * - Setting/Reading the state of the Contactors (see [Contactors](../Drivers/Contactors.html))
 * - Setting/Reading the value of any GPIO inputs/outputs (see [Minions](../Drivers/Minions.html))
 * - Reading the value of the Pedals (see [Pedals](../Drivers/Pedals.html))
 * 
 * Command Line Help:
