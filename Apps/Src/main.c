...
void Task_Init(void *p_arg) {
	...
	OSTaskCreate((OS_TCB *)&FaultState_TCB,
				 (CPU_CHAR *)"FaultState",
	...
	OSTaskCreate((OS_TCB *)&SendTritium_TCB,
	...
	OSTaskCreate((OS_TCB *)&ReadCarCAN_TCB,
				 (CPU_CHAR *)"ReadCarCAN",
	...
	OSTaskCreate((OS_TCB *)&UpdateDisplay_TCB,
	...
	OSTaskCreate((OS_TCB *)&ReadTritium_TCB,
	...
	OSTaskCreate((OS_TCB *)&SendCarCAN_TCB,
				 (CPU_CHAR *)"SendCarCAN",
	...
	Minion_Error_t merr;
	while (1) {
		Contactors_Set(MOTOR_CONTACTOR,
					   Minion_Read_Pin(IGN_2, &merr),
