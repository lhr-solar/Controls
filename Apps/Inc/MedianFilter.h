...
/**
 * @brief Helper function to find the median of an array of MF_TYPE with length
 * MF_DEPTH. DO NOT call this function directly.
 *
...
/**
 * @brief update the median filter by giving it a new set of values for all
 * channels
 *
 * @param filter    a pointer to the median filter
 * @param channels  a complete set of new values for all channels to add to the
 * median filter
 *
 */
static inline void __attribute__((unused))
