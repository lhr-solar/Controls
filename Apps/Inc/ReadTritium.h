/**
 * @file ReadTritium.h
 * @brief Reads messages sent by the Tritium motor controller & handles
 ...
 * automatically forward all messages from MotorCAN to CarCAN, detect and handle
 * motor errors, and forward velocity information to the display.
 *
 */
